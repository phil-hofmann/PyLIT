...
from pylit.backend.utils import generate_multi_index_set, to_string
...
class LinearRegressionModel:
    ...
    def __init__(
        ...
        params: List[np.ndarray[FLOAT_DTYPE]],
    ):
    ...
    def kernel(
        ...
        param: List[np.ndarray[FLOAT_DTYPE]],
    ...
    def __call__(
        self, omega: np.ndarray[FLOAT_DTYPE], matrix: bool = False
    ) -> np.ndarray[FLOAT_DTYPE]:
    ...
    def _generate_multi_index_set(self) -> np.ndarray[INT_DTYPE]:
        """Method for generating the multi index set.

        Returns:
            np.ndarray[INT_DTYPE]
    ...
    def compute_regression_matrix(self) -> np.ndarray[FLOAT_DTYPE]:
